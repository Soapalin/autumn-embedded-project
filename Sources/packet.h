...
/*!< DOR Command */
#define DOR_COMMAND 0x70

#define DOR_IDMT_CHAR 0
#define DOR_IDMT_GET 1
#define DOR_IDMT_SET 2
#define DOR_IDMT_INVERSE 0
#define DOR_IDMT_VINVERSE 1
#define DOR_IDMT_EINVERSE 2

#define DOR_GET_CURRENTS 1

#define DOR_GET_FREQUENCY 2

#define DOR_GET_TRIPPED 3

#define DOR_GET_FAULT 4

#define DOR_COMMAND_CURRENT 0x71
